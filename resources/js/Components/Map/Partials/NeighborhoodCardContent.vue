    ...
    <div
        ...
        <div class="p-5 space-y-5">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div
                    class="bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 rounded-lg p-3">
                    <div class="flex items-center gap-2 mb-1">
                        <Trees class="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
                        <div class="text-[10px] uppercase tracking-tighter text-gray-500 dark:text-gray-400">Total Trees
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <div class="text-[10px] uppercase tracking-tighter text-gray-500 dark:text-gray-400">Avg Canopy
                        </div>
                    </div>
                    <div class="text-xl font-bold text-gray-900 dark:text-gray-100">
            ...
            <div class="space-y-2">
                ...
                <div
                    class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3 space-y-2 text-xs border border-gray-200 dark:border-gray-700">
            ...
            <div v-if="isSelected" class="pt-2">
                <button
                    class="w-full bg-linear-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-md">
