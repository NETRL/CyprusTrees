        ...
        <div class="flex-1 ">
            ...
            <template v-if="selectedFilter === 'origin'">
                <div class="space-y-4 pb-4">
                    ...
                    <div class="space-y-0.5">
                        <LegendItem v-for="item in originLegend" :key="item.key" :color="item.color" :label="item.label"
            ...
            <template v-if="selectedFilter === 'shade'">
                <div class="space-y-4 pb-4">
                    ...
                    <div class="space-y-0.5">
                        <LegendItem v-for="item in shadeLegend" :key="item.key" :color="item.color" :label="item.label"
                            :count="item.count" :icon="item.icon"
                            @toggle="() => emit('toggleCategory', { mode: selectedFilter, key: item.key })" />
