          ...
          <div v-for="(menuGroup, groupIndex) in menuGroups" :key="groupIndex">
            ...
            <ul class="flex flex-col ">
              <li v-for="(item, index) in menuGroup.items" :key="item.name">
                ...
                <Link v-else-if="item.path" :href="route(item.path)" :class="[
                  'menu-item group',
                  {
    ...
    items: [
      {
        ...
        subItems: [
          ...
          { name: "Analytics", path: "/", pro: false, new: true },
          { name: "CRM", path: "/", pro: true, new: false }
        ],
      },
      {
        icon: CalenderIcon,
...

      {
        ...
        icon: ListIcon,
        subItems: [
          // { name: "Form Elem/ents", path: "/form-elements", pro: false },
        ],
      },
      {
        name: "Tables",
