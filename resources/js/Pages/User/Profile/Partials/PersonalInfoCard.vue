              ...
              <form @submit.prevent="updateProfile" class="flex flex-col">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div class="col-span-2 lg:col-span-1">
                    ...
                    <input id="first_name" type="text" v-model="infoForm.first_name" autocomplete="given-name"
                      class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    <InputError :message="infoForm.errors.first_name" class="mt-2" />
                  </div>
                  ...
                  <div class="col-span-2 lg:col-span-1">
                    ...
                    <input id="last_name" type="text" v-model="infoForm.last_name" autocomplete="family-name"
                      class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    <InputError :message="infoForm.errors.last_name" class="mt-2" />
                  </div>
                  ...
                  <div class="col-span-2 lg:col-span-1">
                    ...
                    <input id="email" type="email" v-model="infoForm.email" autocomplete="email"
                      class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    <InputError :message="infoForm.errors.email" class="mt-2" />
                  </div>
                  ...
                  <div class="col-span-2 lg:col-span-1">
                    ...
                    <input id="phone" type="tel" v-model="infoForm.phone" autocomplete="tel"
                      class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    <InputError :message="infoForm.errors.phone" class="mt-2" />
                  </div>
                </div>
                <div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
                  <button :disabled="infoForm.processing" type="submit"
