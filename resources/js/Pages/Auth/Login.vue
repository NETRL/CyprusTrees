                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <input v-model="form.email" type="email" id="email" name="email" placeholder="info@gmail.com"
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <Link v-if="canResetPassword" :href="route('password.request')"
                        class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">Forgot password?</Link>
                    </div>
                    <!-- Button -->
                    <div>
                      <button type="submit"
