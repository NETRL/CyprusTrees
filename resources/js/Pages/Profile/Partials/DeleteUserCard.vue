            ...
            <template #body>
                <div
                    ...
                    <form @submit.prevent="deleteUser">
                        <div class="mt-1 block w-1/2">
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Password
                            </label>
                            <Password id="password" type="password" v-model="form.password" autocomplete="password"
                                inputClass="w-full border-transparent! shadow-none! rounded-lg!"
